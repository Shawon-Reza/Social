...
const Navbar = () => {
    ...
    return (
        <nav className="bg-yellow-500 px-4 py-2 flex items-center justify-between">
            {/* Logo/Brand */}
            ...
            <div className="hidden md:flex flex-1 items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                    <button
                        ...
                        title="Home"
                    >
                        <FaHome className="w-6 h-6 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="People"
                    >
                        <FaUserFriends className="w-6 h-6 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="Company"
                    >
                        <BiStore className="w-6 h-6 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="Groups"
                    >
                        <FaUsers className="w-6 h-6 text-gray-700 cursor-pointer" />
                    </button>
                </div>
                ...
                <form onSubmit={handleSearch} className="flex-1 max-w-md mx-8 hidden lg:block">
                    <div className="relative">
                        ...
                        >
                            <IoMdSearch className="w-5 h-5 cursor-pointer" />
                        </button>
                    </div>
                </form>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <MdExpandLess size={24} className="text-gray-700 rotate-180 cursor-pointer" />
            ...
            {isMenuOpen && (
                <div className="absolute top-18 left-0 w-full bg-yellow-500 shadow-md flex flex-col p-4 space-y-3 md:hidden z-50">
