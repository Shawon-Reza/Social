...
const Navbar = () => {
    ...
    return (
        <nav className="bg-yellow-500 px-4 py-2 md:py-4 flex items-center justify-between">
            {/* Logo/Brand */}
            ...
            <div className="hidden md:flex flex-1 items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                    <button
                        ...
                        title="Home"
                    >
                        <FaHome className="w-7 h-7 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="People"
                    >
                        <FaUserFriends className="w-7 h-7 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="Company"
                    >
                        <BiStore className="w-7 h-7 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="Groups"
                    >
                        <FaUsers className="w-7 h-7 text-gray-700 cursor-pointer" />
                    </button>
                </div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button
                        ...
                        title="Messages"
                    >
                        <FaComment className="w-7 h-7 text-gray-700 cursor-pointer" />
                    </button>
                    ...
                    <button
                        ...
                        title="Notifications"
                    >
                        <FaBell className="w-7 h-7 text-gray-700 cursor-pointer" />
                    </button>
